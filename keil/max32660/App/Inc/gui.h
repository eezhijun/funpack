...
void LCD_ShowflashNum(u16 x,u16 y,u16 num,u8 len,u16 fc,u16 bc,u8 sizey);
...
//void LCD_SDFRESH(FIL *fp);
//void LCD_SDDrawPoint(u16 x,u16 y,u16 color,FIL *fp);
//void LCD_SDCLR(FIL *fp);
...
//extern FIL f_clock_R; //file
//extern FIL f_clock_W; //file
