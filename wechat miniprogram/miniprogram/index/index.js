...
Page({
   ...
   humidityCharId: "00002A6F-0000-1000-8000-00805F9B34FB",
   pressureCharId: "00002A6D-0000-1000-8000-00805F9B34FB",
   ambientCharId: "936B6A25-E503-4F7C-9349-BCC76C22B8C3",
   noiseCharId: "836B6A25-E503-4F7C-9349-BCC76C22B8C3",
   },
      ...
      wx.createBLEConnection({
         ...
         success: function(res) {
            ...
            setInterval(function() {
               ...
               that.readBLECharacteristicValue(0);
               that.readBLECharacteristicValue(1);
               that.readBLECharacteristicValue(2);
               that.readBLECharacteristicValue(3);
               that.readBLECharacteristicValue(4);
            }, 2000); 
            that.setData({
               /* 更新显示可用设备开关 */
   ...
   /* 读取低功耗蓝牙设备的特征值的二进制数据值 */
   readBLECharacteristicValue: function(environmentType) {
      var that = this;
      ...
      switch(environmentType)
      {
         case 0:
            wx.readBLECharacteristicValue({
               ...
               serviceId: that.data.services[0].uuid, /* arduino */
               // 这里的 characteristicId 需要在 getBLEDeviceCharacteristics 接口中获取
               characteristicId:  that.data.tempertureCharId,
               success(res) {
                  console.log('readBLECharacteristicValue tempertureCharId suceess:', res.errCode)
               }
            })
            break;
         case 1:
            wx.readBLECharacteristicValue({
               ...
               serviceId: that.data.services[0].uuid, /* arduino */
               // 这里的 characteristicId 需要在 getBLEDeviceCharacteristics 接口中获取
               characteristicId:  that.data.humidityCharId,
               success(res) {
                  console.log('readBLECharacteristicValue humidityCharId suceess:', res.errCode)
               }
            })
            break;
         case 2:
            wx.readBLECharacteristicValue({
               ...
               serviceId: that.data.services[0].uuid, /* arduino */
               // 这里的 characteristicId 需要在 getBLEDeviceCharacteristics 接口中获取
               characteristicId:  that.data.pressureCharId,
               success(res) {
                  console.log('readBLECharacteristicValue pressureCharId suceess:', res.errCode)
               }
            })
            break;
         case 3:
            wx.readBLECharacteristicValue({
               ...
               serviceId: that.data.services[0].uuid, /* arduino */
               // 这里的 characteristicId 需要在 getBLEDeviceCharacteristics 接口中获取
               characteristicId:  that.data.ambientCharId,
               success(res) {
                  console.log('readBLECharacteristicValue ambientCharId suceess:', res.errCode)
               }
            })
            break;
         case 4:
            wx.readBLECharacteristicValue({
               ...
               serviceId: that.data.services[0].uuid, /* arduino */
               // 这里的 characteristicId 需要在 getBLEDeviceCharacteristics 接口中获取
               characteristicId:  that.data.noiseCharId,
               success(res) {
                  console.log('readBLECharacteristicValue noiseCharId suceess:', res.errCode)
               }
            })
            break;
         default:
   ...
   getBLEDeviceCharacteristics: function() {
      var that = this;
      var myuuid = that.data.services[0].uuid; //具有读写通知属性的服务uuid
